...
namespace WebStore.Tests.UnitTests.Admin.Products
{
    ...
    public class GetProductTest
    {
        ...
        public void RunValidTest(GetProduct getProduct, int Id)
        {
            var actual = getProduct.Do(Id);
            actual.Should().NotBeNull();
            actual.Name.Should().BeEquivalentTo(product.Name);
            actual.Description.Should().BeEquivalentTo(product.Description);
        }

        public void RunBadTest(GetProduct getProduct, int Id)
        {
            var actual = getProduct.Do(Id);
