...
{
    [TestClass]
    public class GetProductByInventoryIdTest
    {
        ...
        [TestMethod]
        public void TestGetProductByInventoryId()
        {
            ...
            var getProduct = new GetProductByInventoryId(mockContext.Object);

            RunValidTest(getProduct, 1);
            RunBadTest(getProduct, -1);
        }

        public void RunValidTest(GetProductByInventoryId getProduct, int Id)
        {
            var actual = getProduct.Do(Id);
        ...
        public void RunBadTest(GetProductByInventoryId getProduct, int Id)
        {
            var actual = getProduct.Do(Id);
