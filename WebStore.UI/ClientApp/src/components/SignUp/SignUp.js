...
export default class SignUp extends React.Component {
    ...
    onSubmit(event) {
        ...
        axios.post(process.env.REACT_APP_API_HOST + '/api/User/create', { email: this.state.email, password: this.state.password })
            .then(res => {
                ...
                if (err.response.status === 409)
                    this.setState({ warnText: "Email has already been taken!" });
                else
                ...
                <div className="container has-text-centered">
                    <form onSubmit={this.onSubmit.bind(this)}>
                        <div style={inlineBlock}>
                            <div className="has-text-left has-text-weight-bold is-size-3"><h2>Sign Up:</h2></div><br />
